  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Onboard New School</h1>
          <p className="text-slate-400 mt-1">Provision a new isolated database instance and admin account.</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-white border-b border-slate-800 pb-2">School Details</h3>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input 
                  ...
                  className="pl-10 bg-slate-950 border-slate-800 text-white focus-visible:ring-green-500"
                  required
                />
              </div>
          ...
          <div className="space-y-4 pt-4">
            <h3 className="text-lg font-medium text-white border-b border-slate-800 pb-2">Super Admin Account</h3>
