const url = "https://xgfikdhcudyixwbwlcuh.supabase.co/rest/v1/orders?select=*,master_orders(display_id),fulfillments(*,locations(name,q_commerce_enabled))&order=created_at.desc&limit=1";
