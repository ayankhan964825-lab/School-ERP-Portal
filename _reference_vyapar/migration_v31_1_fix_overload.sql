-- ==============================================================================
-- MIGRATION: v31.1 - Fix Function Overloading
-- Description: Drops overloaded RPCs and restores the correct one
-- ==============================================================================

-- Drop all possible variations to clear the overloading ambiguity
DROP FUNCTION IF EXISTS atomic_create_marketplace_order(jsonb, jsonb, boolean);
DROP FUNCTION IF EXISTS atomic_create_marketplace_order(jsonb, jsonb, jsonb, boolean, boolean, boolean, jsonb, boolean, boolean);
DROP FUNCTION IF EXISTS atomic_create_marketplace_order(jsonb, jsonb, jsonb, boolean, boolean, boolean, text[], boolean, boolean);
