-- Fix affiliate_id column type mismatch and remove incorrect UUID cast

-- 1. Alter the orders table to make sure affiliate_id is TEXT
ALTER TABLE orders ALTER COLUMN affiliate_id TYPE TEXT;

-- 2. Re-create the RPC without the ::UUID cast for affiliate_id
